...
export class MessagingService {
  ...
  // shutdown, e.g. a socket disconnecting while app.close() is tearing down
  // the Redis client) must never throw into a socket connect/disconnect
  // handler, or it surfaces as an unhandled rejection.
