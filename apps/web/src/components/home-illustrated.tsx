    ...
    <>
      ...
      <div className="space-y-12 sm:space-y-16">
        ...
        <section
          ...
          className="-mx-4 -mt-4 bg-background px-4 pb-6 pt-6 sm:-mx-6 sm:-mt-6 sm:px-8 sm:pt-14 [@media(max-height:700px)]:pt-2"
        >
          <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-6 lg:grid-cols-2 lg:gap-16 [@media(max-height:700px)]:gap-2">
            {/* Photo */}
            <div className="relative order-1 mx-auto w-full max-w-[460px] lg:max-w-none">
              ...
              <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-br from-accent to-marigold-soft px-6 pt-5 sm:px-10 sm:pt-8 [@media(max-height:700px)]:pt-1.5">
                <img
                  src="/hero-students-group.webp"
                  alt="Four students collaborating on a laptop"
                  className="mx-auto w-full max-w-[460px] object-contain [@media(max-height:700px)]:max-w-[220px]"
                />
              </div>
            </div>
            ...
            <div className="order-2 text-center lg:text-left">
              ...
              <h1 className="mt-3 font-display text-[clamp(32px,6vw,64px)] font-extrabold uppercase leading-[1.1] tracking-[-.02em] [@media(max-height:700px)]:mt-1.5">
                Success Network
              </h1>
              <p className="mx-auto mt-4 max-w-[520px] text-[17px] leading-relaxed text-muted-foreground lg:mx-0 [@media(max-height:700px)]:mt-2">
                Find the right college, discover scholarships and internships, and get guidance from verified students and trusted experts.
              </p>
              <p className="mt-6 text-[14px] font-semibold uppercase tracking-[.25em] [@media(max-height:700px)]:mt-3">Start your search</p>
              <div className="mt-3 flex flex-col items-center gap-2 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-4 lg:justify-start [@media(max-height:700px)]:mt-1 [@media(max-height:700px)]:gap-1">
