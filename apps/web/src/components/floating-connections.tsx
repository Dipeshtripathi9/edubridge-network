  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 flex items-stretch gap-2 overflow-x-clip pl-2.5">
      ...
      <nav
        ...
        className={cn(
          'pointer-events-auto flex h-[60px] min-w-0 basis-0 grow-[72] items-stretch gap-1.5 rounded-full bg-card p-1.5 shadow-[0_6px_20px_rgba(0,0,0,0.10)] transition-transform duration-300 ease-out motion-reduce:transition-none',
