  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 flex items-stretch gap-2 overflow-x-clip pl-2.5">
      ...
      <nav
        ...
        className={cn(
          'pointer-events-auto flex h-[60px] min-w-0 basis-0 grow-[72] items-stretch rounded-full bg-card p-1.5 shadow-[0_6px_20px_rgba(0,0,0,0.10)] transition-transform duration-700 ease-out motion-reduce:transition-none',
      ...
      <Link
        ...
        className={cn(
          'pointer-events-auto flex h-[46px] min-w-0 basis-0 grow-[28] items-center justify-center gap-1 self-center overflow-hidden rounded-l-full px-2 text-white shadow-[0_6px_18px_rgba(47,191,155,0.42)] transition-transform duration-300 ease-out motion-reduce:transition-none hover:brightness-95',
