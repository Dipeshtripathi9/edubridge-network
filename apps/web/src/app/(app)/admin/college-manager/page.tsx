...
import { Field, BoolField, SectionLabel, ConfirmDeleteButton } from '@/components/admin/catalog-form-helpers';
...
export default function CollegeManagerPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Add, edit, and remove colleges and their courses in the catalog.</p>
      </div>
